...
const ProfilePage = () => {
    ...
    const hundleFollow = async()=>{
        ...
        try{
            axios.put(`https://backend-side-h758.onrender.com/api/user/addfriend`,userData)
...
axios.get(`https://backend-side-h758.onrender.com/api/user/checkFriendship/${userData?.user}/${userData.data?.user_id}`)
